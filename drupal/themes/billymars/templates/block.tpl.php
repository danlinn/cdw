...
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?>">
  <?php if ($title){ ?>
  		<?php if ($title=="Upcoming Events") { print "<a href='/news/events'>"; } elseif ($title=="Upcoming Classes") { print "<a href='/news/classes'>"; } elseif ($title=="Upcoming Appearances") { print "<a href='/news/appearances'>"; } ?>
    <h2 class="title"><?php print $title; ?></h2>
    <?php if ($title=="Upcoming Events" || $title=="Upcoming Classes" || $title=="Upcoming Appearances") { print "</a>"; } ?>
  <?php } ?>
