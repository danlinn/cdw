	...
	<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix">
		  <?php //print $user_picture; ?>
		    ...
		    <div id="subheader">
		    	...
		    	<?php print $node->field_subhead[0]['view'] ?>
		    </div>
			...
			<div class="content" id="subcontent">
				<div id="subbody">
		  		...
		  		<?php //if ($page == 0): ?>
		    	<p>
		    		<h1 class="title"><?php if (!$page) { ?><a href="<?php print $node_url ?>" title="<?php print $title ?>"><?php } ?><?php print $title ?><?php if (!$page) { ?></a><?php } ?></h1>
		    	</p>
		 	 		<?php //endif; ?>
		  		<?php print $picture ?>
